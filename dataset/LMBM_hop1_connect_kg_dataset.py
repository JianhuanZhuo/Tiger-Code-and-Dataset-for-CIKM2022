...
class LMBMhop1ConnectKGDataset(BBMhop1ConnectKGDataset):
    @property
    def raw_folder(self):
        return "LMBM-hop1-connect"

    @property
    def raw_file(self):
        return "LMBM-hop1-connect.csv"
...
if __name__ == '__main__':
    ...
    dataset1 = LMBMhop1ConnectKGDataset(config=cfg, split_mode='all_for_train')
    if dataset1.kg:
        pass
