...
class ML1Mdc5geDataset(CFKGAdaptor, ML100KDataset):
    def cfg_name(self):
        return "ML1M-dc5ge", "ML1M-dc5ge.csv", "\t"
...
class ML1Mdc5geAvgDataset(CFHistAdaptor, ML1Mdc5geDataset):
    pass
...
if __name__ == '__main__':
    ...
    dataset1 = ML1Mdc5geDataset(config=cfg)
