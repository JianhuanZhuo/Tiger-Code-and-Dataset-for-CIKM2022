...
class LFM1Mdc5geDataset(CFKGAdaptor, ML100KDataset):
    def cfg_name(self):
        return "lfm1Mdc5ge", "lfm1Mdc5ge.csv", "\t"
...
class LFM1Mdc5geAvgDataset(CFHistAdaptor, LFM1Mdc5geDataset):
    pass
...
if __name__ == '__main__':
    ...
    dataset1 = LFM1Mdc5geAvgDataset(config=cfg)
