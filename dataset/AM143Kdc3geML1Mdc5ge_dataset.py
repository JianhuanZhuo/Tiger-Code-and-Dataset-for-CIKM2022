...
class AM143Kdc3geML1Mdc5geDataset(CFKGAdaptor, ML100KDataset):
    def cfg_name(self):
        return "AM143Kdc3geML1Mdc5ge", "AM143Kdc3geML1Mdc5ge.csv", "\t"

    def fetch_dataset(self, rating_file):
        url = "https://github.com/JianhuanZhuo/dataset-package/releases/download/v0.0.2/" \
              "AM143Kdc3geML1Mdc5ge.csv.zip"
...
class AM143Kdc3geML1Mdc5geAvgDataset(CFHistAdaptor, AM143Kdc3geML1Mdc5geDataset):
    pass
...
if __name__ == '__main__':
    ...
    dataset1 = AM143Kdc3geML1Mdc5geDataset(config=cfg)
