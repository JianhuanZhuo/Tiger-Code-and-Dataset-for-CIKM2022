...
from tools.utils import cache_or, Timer


class BasedSamplingSpace:
    def __init__(self, num_user, num_item, dataset,
                 device,
                 train_set=None,
                 title=None,
                 cache_base=None,
...
class FastSamplingSpace(BasedSamplingSpace):
    """
    快速采样方法
    """
    def __init__(self, num_user, num_item, dataset, device,
                 ...
                 enable_sampling_record=True,
                 enable_sampling_negative=True,
                 enable_sampling_positive=False):
        super().__init__(num_user, num_item, dataset, device, train_set, title, cache_base, cache_folder, in_grid,
                         enable_sampling_record, enable_sampling_negative)
