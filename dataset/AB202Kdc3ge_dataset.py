...
class AB202Kdc3Dataset(ML100KDataset):
    def cfg_name(self):
        return "AB202Kdc3ge", "AB202Kdc3ge.csv", "\t"
...
class AB202Kdc3geDataset(CFKGAdaptor, AB202Kdc3Dataset):
    pass


class AB202Kdc3geAvgDataset(CFHistAdaptor, AB202Kdc3geDataset):
    pass
...
if __name__ == '__main__':
    ...
    dataset1 = AB202Kdc3geDataset(config=cfg)
