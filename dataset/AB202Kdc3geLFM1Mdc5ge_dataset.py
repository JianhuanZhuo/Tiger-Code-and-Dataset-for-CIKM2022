...
class AB202Kdc3geLFM1Mdc5geDataset(CFKGAdaptor, ML100KDataset):
    def cfg_name(self):
        return "AB202Kdc3geLFM1Mdc5ge", "AB202Kdc3geLFM1Mdc5ge.csv", "\t"

    def fetch_dataset(self, rating_file):
        url = "https://github.com/JianhuanZhuo/dataset-package/releases/download/v0.0.2/" \
              "AB202Kdc3geLFM1Mdc5ge.csv.zip"
...
class AB202Kdc3geLFM1Mdc5geAvgDataset(CFHistAdaptor, AB202Kdc3geLFM1Mdc5geDataset):
    pass
...
if __name__ == '__main__':
    ...
    dataset1 = AB202Kdc3geLFM1Mdc5geDataset(config=cfg)
