...
class AM143Kdc3Dataset(ML100KDataset):
    def cfg_name(self):
        return "AM143Kdc3ge", "AM143Kdc3ge.csv", "\t"
...
class AM143Kdc3geDataset(CFKGAdaptor, AM143Kdc3Dataset):
    pass


class AM143Kdc3geAvgDataset(CFHistAdaptor, AM143Kdc3geDataset):
    pass
...
if __name__ == '__main__':
    ...
    dataset1 = AM143Kdc3geDataset(config=cfg)
